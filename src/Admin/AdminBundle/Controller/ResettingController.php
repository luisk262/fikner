...
class ResettingController extends Controller
{
    ...
    public function requestAction(Request $request)
    {
        ...
        if($data){
            return $this->render('AdminAdminBundle:Resetting:request.html.twig',array('data'=>$data));
        }else{
            return $this->render('AdminAdminBundle:Resetting:request.html.twig');
        }
    ...
    public function checkEmailAction(Request $request)
    {
        ...
        return $this->render('AdminAdminBundle:Resetting:check_email.html.twig', array(
