...
use Admin\AgenciaBundle\Form\RegistrationType;

/**
 * User controller.
 *
 * @Route("Agencia/registration")
 */
class RegistrationController extends Controller {
     ...
     *
     * @Route("/", name="Agencia_registration_create")
     * @Method("POST")
     * @Template("AdminAgenciaBundle:Registration:new.html.twig")
     */
        ...
        if ($form->isValid()) {
            ...
            if ($query->getResult()) {
                ...
                return $this->redirect(
                                $this->generateUrl('Agencia_registration_msg', array('id' => $entity->getId(),
    ...
    private function createCreateForm(User $entity) {
        $form = $this->createForm(new RegistrationType(), $entity, array(
            'action' => $this->generateUrl('Agencia_registration_create'),
            'method' => 'POST',
        ));
     ...
     *
     * @Route("/", name="Agencia_registration_new")
     * @Method("GET")
     * @Template()
     */
